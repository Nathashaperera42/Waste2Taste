...
const Cart = () => {
    const {products,currency,cartItems,getCartCount,getCartAmount,updateCartItem,removeFromCart,navigate}= useAppContext()
  ...
  return products.length > 0 && cartItems ? (
       <div className="flex flex-col md:flex-row py-16 mt-16">
            <div className='flex-1 max-w-4xl'>
                        ...
                        <div className="flex items-center md:gap-6 gap-3">
                            ...
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    <p>Collect time: <span>{product.collecttime || "N/A"}</span></p>
                ...
                <button onClick={()=>{navigate('/products')}}className="group cursor-pointer flex items-center mt-8 gap-2 text-green-500 font-medium">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="text-gray-500 mt-4 space-y-2">
                    ...
                    <p className="flex justify-between">
                        <span>Coins(10%)</span><span>{currency}{getCartAmount()*10/100}</span>
                    </p>
